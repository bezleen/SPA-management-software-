...
ALTER TABLE CTDT ADD FOREIGN KEY (MABS) REFERENCES QLBS(MABS)
ALTER TABLE CTDT ADD FOREIGN KEY (MAKH) REFERENCES KHACHHANG(MAKH)
ALTER TABLE CTDT ADD FOREIGN KEY (MALT) REFERENCES LIEUTRINH(MALT)
----Viz
CREATE TABLE HOADON(
    SOHD INT,
	MAKH NVARCHAR(100),
...
ALTER TABLE CTHD ADD FOREIGN KEY(MAMP) REFERENCES MYPHAM(MAMP)
