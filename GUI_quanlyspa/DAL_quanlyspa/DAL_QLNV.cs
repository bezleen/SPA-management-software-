    ...
    public class DAL_QLNV
    {
        ...
        public void _insertData(DTO_QLNV val)
        {
            con._insert_update_delete(@"INSERT INTO QLNV
                      (MANV, HOTEN, GIOITINH, NHIEMVU, QUEQUAN, DIACHI, SDT, HESOLUONG, NBDHD, NKTHD) VALUES (N'" + val.MANV + "',N'" + val.HOTEN + "',N'" + val.GIOITINH + "',N'" + val.NHIEMVU + "',N'" + val.QUEQUAN + "',N'" + val.DIACHI + "',N'" + val.SDT + "',N'" + val.HESOLUONG + "',N'" + val.NBDHD + "',N'" + val.NKTHD +  "')");
        }
        // ham update
